import GameInstance from '@lib/classes/GameInstance';
...
const Game = (props: Props) => {
  ...
  return (
    ...
    <>
      ...
      >
        <Player className="h-[128px] flex-shrink-0" player={GameInstance.enemy} />
        <Board className="my-4 flex-grow" />
        <Player className="h-[256px] flex-shrink-0" player={GameInstance.player} />
      </main>
      <GameStartMenu />
      <GameSettingsMenu />
    </>
